    ...
    public partial class RegistrationServices : Form
    {
        ...
        public void PopulateGuestCombo()
        {
            ...
            try
            {
                ...
                string sql;
                sql = "SELECT FirstName,LastName from Guest;";
                ...
                while (dbReader.Read())
                {
                    ...
                    cmbGuest.Items.Add(dbReader["FirstName"].ToString());
                }
                //close Reader
                dbReader.Close();
        ...
        private void btnRegister_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                sql = "Insert into Guest(LastName, FirstName, Street, City, State, Zip, Phone, Email, Room) Values (@FirstName, @LastName, @Street, @City, @State, @Zip, @Phone, @Email, @Room);";
                ...
                dbCmd.Parameters.AddWithValue("@Room", cmbRoomAvailable.Text);
